...
namespace QuanLyChiTieuBackend.DAO
{
	public class ChiTieuDAO
	{
		...
		{
			string query = "EXEC usp_ChiTieu_ThemChiTietChiTieu @Ten , @Nhom , @SoTien , @NgayChiTieu";
			object[] param = new object[] {chiTieuDTO.TenChiTieu,chiTieuDTO.Nhom,chiTieuDTO.SoTien,chiTieuDTO.NgayChiTieu};
