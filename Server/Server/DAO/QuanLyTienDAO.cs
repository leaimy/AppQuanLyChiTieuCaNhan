...
namespace Server.DAO
{
	public class QuanLyTienDAO
	{
		...
		public bool ThemQuanLyTien(ThemQuanLyTienDTO quanLyTienDTO)
		{
			string query = "EXEC usp_QuanLyTien_ThemQuanLyTien @IdNguoiDung , @ngayBD , @ngayKT";
			object[] param = new object[] { quanLyTienDTO.IdNguoiDung, quanLyTienDTO.NgayBD, quanLyTienDTO.NgayKT};
		...
		public bool ThemNguonThu(QuanLyTienThongKeNguonThuDTO themNguonThu)
		{
			string query = "EXEC usp_ThemNguonThu @IdQuanLyTien , @SoTien , @Nhom";
			object[] param = new object[] {themNguonThu.QuanLyTienID, themNguonThu.SoTien, themNguonThu.Nhom};
